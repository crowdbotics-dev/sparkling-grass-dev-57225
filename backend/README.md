...
## Project Structure
    ...
    ├── sparkling_grass_dev_57225  # Django project configurations
...
1. Clone this repo and `cd sparkling_grass_dev_57225`
...
2. Clone this repo and `cd sparkling_grass_dev_57225`
